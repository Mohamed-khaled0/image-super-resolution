...
<section
      id="upload-section"
      className="w-full lg:w-[70%] xl:w-[60%] 2xl:w-[60%] min-h-[55vh] mx-auto mb-20 flex flex-col justify-center items-center bg-white dark:bg-gray-900   mt-10  dark:text-white rounded-3xl border-4 border-dashed border-fuchsia-500 p-2 md:p-6"
    >
